<?php /*a:5:{s:77:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\message\index.html";i:1566875768;s:74:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\top.html";i:1564537202;s:77:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\header.html";i:1564563722;s:75:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\menu.html";i:1565232038;s:73:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\js.html";i:1565071540;}*/ ?>
<!DOCTYPE html>
	<html lang="en">
		<head>
			<meta charset="UTF-8">
			...
			<block name="js">
				...
				<script>
					function setMessage(){
						...
						$.ajax({
							type:'post',
							url:"<?php echo url('admin/Message/getData'); ?>",
					...
					function sendMessage(){
						...
						$.ajax({
							type:'post',
							url:"<?php echo url('/admin/Message/checkPhoneAndCode'); ?>",
				    ...
				    // 	$.ajax({
				    // 		type:'post',
				    // 		url:"<?php echo url('/admin/Message/index'); ?>",
				    // 		data:DataForm,
				    // 		dataType:'json',
				    // 		success:function(data){
				    // 			toastr.success('', data.msg);
