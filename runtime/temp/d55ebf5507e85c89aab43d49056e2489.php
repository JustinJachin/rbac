<?php /*a:5:{s:75:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\action\edit.html";i:1565857851;s:74:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\top.html";i:1564537202;s:77:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\header.html";i:1564563722;s:75:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\menu.html";i:1565232038;s:73:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\js.html";i:1565071540;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
									...
									<div class="card-body cards">
										<form id="form" class="form-horizontal" method="post" onsubmit="return false" enctype="multipart/form-data"  target="addfile">
											...
											<div class="form-group row">
												...
												<div class="col-md-4">
													<input id="actionName" type="text" class="form-control" value="<?php echo htmlentities($vo['actionName']); ?>" name="actionName" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-2 col-form-label">行为名称</label>
												<div class="col-md-4">
													<input id="actionTitle" type="text" class="form-control" value="<?php echo htmlentities($vo['actionTitle']); ?>"  name="actionTitle" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-2 col-form-label">行为说明</label>
												<div class="col-md-4">
													<input id="remark" type="text" class="form-control" value="<?php echo htmlentities($vo['remark']); ?>" name="remark" >
												</div>
											</div>
...
<block name="js">
	<script type="text/javascript">
		$("#form").submit(function(){
			...
			$.ajax({
				type:'post',
				url:"<?php echo url('/admin/action/edit'); ?>",
				data:formData,
				dataType:'json',
