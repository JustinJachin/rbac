<?php /*a:5:{s:78:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\admin\editRole.html";i:1564737145;s:74:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\top.html";i:1564537202;s:77:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\header.html";i:1564563722;s:75:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\menu.html";i:1565232038;s:73:"E:\phpStudy\PHPTutorial\WWW\tp5rbac\application\admin\view\public\js.html";i:1565071540;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
								...
								<div class="card ">
									...
									<div class="card-body cards">
										<form id="form" class="form-horizontal" onsubmit="return false" method="post" enctype="multipart/form-data"  target="addfile">
											...
											<?php endif; if($vo['flat'] == 1): ?>
												<div class="col-md-3 text-center">
													<label>
														<input type="checkbox" class="flat-purple col-form-label" name="<?php echo htmlentities($vo['id']); ?>" value="<?php echo htmlentities($vo['id']); ?>" checked>
											...
											<?php else: ?>
												<div class="col-md-3 text-center">
													<label>
														<input type="checkbox" class="flat-purple col-form-label"  name="<?php echo htmlentities($vo['id']); ?>" value="<?php echo htmlentities($vo['id']); ?>">
													<?php echo htmlentities($vo['description']); ?>
													</label>
												</div>
											<?php endif; if($vo['lineEnd'] == 1): ?>
											</div>
											<?php endif; ?>
											<?php endforeach; endif; else: echo "" ;endif; ?>
