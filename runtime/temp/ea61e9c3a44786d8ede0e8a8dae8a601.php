<?php /*a:5:{s:66:"G:\phpstudy_pro\WWW\tp5rbac\application\admin\view\admin\edit.html";i:1564732536;s:66:"G:\phpstudy_pro\WWW\tp5rbac\application\admin\view\public\top.html";i:1564537202;s:69:"G:\phpstudy_pro\WWW\tp5rbac\application\admin\view\public\header.html";i:1564563722;s:67:"G:\phpstudy_pro\WWW\tp5rbac\application\admin\view\public\menu.html";i:1565232038;s:65:"G:\phpstudy_pro\WWW\tp5rbac\application\admin\view\public\js.html";i:1596693423;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
				...
				<div class="app-content">
					<section class="section">
                    	<ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">管理员编辑</li>
                        </ol>
									...
									<div class="card-body cards">
										<form id="form" class="form-horizontal" onsubmit="return false" enctype="multipart/form-data"  target="addfile">
											<div class="form-group row text-center">
												...
												<label class="col-md-2 col-form-label text-center">用户名</label>
												<div class="col-md-4">
													<input id="username" type="text" class="form-control" disabled="disabled" placeholder="user name" name="name" value="<?php echo htmlentities($user['name']); ?>">
												</div>
											</div>
											<div class="form-group row text-center">
												
												<label class="col-md-2 col-form-label text-center">密 码
												</label>
												<div class="col-md-9">
...
<block name="js">
	<script type="text/javascript">
		$("#form").submit(function(){
			...
			$.ajax({
				type:'post',
				url:"<?php echo url('/admin/admin/editPass'); ?>",
				data:formData,
				dataType:'json',
